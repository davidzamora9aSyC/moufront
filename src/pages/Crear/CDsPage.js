...
function CDsPage() {
  ...
  return (
    <div className="mx-6 my-16 xl:mx-20 2xl:mx-40 3xl:px-60 4xl:px-80">
      <div className="mx-auto flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 lg:space-x-40 lg:px-20">
      ...
      <div className="w-full text-gray-600 lg:px-20 mb-20">
        ...
        <h3 className="text-xl font-bold mb-2">Abre un CD con MOU Investments</h3>
        <p>
