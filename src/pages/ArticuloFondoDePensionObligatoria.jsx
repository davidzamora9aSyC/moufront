        ...
        <div className="p-6">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 lg:space-x-40">
                <div className="lg:w-1/2">
                    <h1 className="text-3xl font-bold mb-20">Fondos de pensión obligatoria</h1>
            ...
            <div className="w-full text-gray-600 px-72 mt-16 mb-20">
                ...
                <p className="mb-6">
                    Colombia tiene dos régimenes de pensiones que coexisten y que los trabajadores pueden elegir según su conveniencia:
                </p>
